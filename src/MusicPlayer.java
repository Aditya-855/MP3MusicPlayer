...
public class MusicPlayer extends PlaybackListener {
    ...
    //boolean flag is used to tell when the song has finished
    ...
    public void loadPlaylist(File playListFile){
        ...
        if (playlist.size()>0){
            ...
            //update current song to the first songmin the playlist
    ...
    public void prevSong(){
        ...
        //check to see if we can go to the previos song
    ...
    public void playbackFinished(PlaybackEvent evt) {
        //this method gets called when the song finishes or if the player get closed
